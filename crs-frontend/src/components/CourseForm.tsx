...
interface CourseFormProps {editingCourse: Course | null; // null = dang o che do Them; co gia tri = dang Sua
...
// Moi lan editingCourse thay doi (bam nut Sua tren 1 dong khac), mo li du lieu vao form
    useEffect(() => {
        if (editingCourse) {
            setValues({
        ...
        <form onSubmit={handleSubmit} style={{ border: '1px solid #ddd',
            ...
            <div style={{ marginBottom: 8 }}>
                ...
                <input
                    ...
                    onChange={(e) => setValues({ ...values, soTinChi:
            ...
            <div style={{ marginBottom: 8 }}>
                ...
                <input
                    ...
                    onChange={(e) => setValues({ ...values, soChoToiDa:
            ...
            <button type="submit" disabled={submitting}>
                {submitting ? 'Dang luu...' : (editingCourse ? 'Cap nhat' :
